...
P.S. Ako želite biti dio kul ekipa koja dobije ping, provjerite jeste li podesili Discord username na https://odgprg.org !`;
        ...
        console.log(`NAME:${notifsChannelName}`, notificationsChannel, botClient.channels.cache.toJSON().map((it) => ({ name: it.name, guild: it.guild.name })));
